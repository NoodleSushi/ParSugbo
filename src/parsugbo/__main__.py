...
class Parser(object):
    ...
    def pred_phrase(self):
        ...
        if VERB in self.current_token.type:
            ...
            mid_adv = self.adverb()
            verb_phrase = (
                self.verb_phrase() if VERB in self.current_token.type else None
            )
            end_adv = self.adverb()
    ...
    def verb_complex(self):
        ...
        if CLIT_Y in self.current_token.type:
            ...
            return VerbComplex(
                Word(word.prefix, pre), Word(verb, VERB), Word(word.suffix, suff)
            )
    ...
    def noun_phrase(self):
        ...
        if IKA in self.current_token.type:
            ...
            [DET_PLURAL, PRON_POS_PLURAL, PRON_POS_PLURAL_NG, PRON_PER_PLURAL, MGA]
        ):
    ...
    def noun_phrase_singular(self):
        ...
        if PRON_PER in self.current_token.type:
            ...
            return NounPhraseSingularPlural(
                "Singular", Word(personal, PRON_PER), extra=clit
            )
            ...
            noun = self.noun_singular()
            return NounPhraseSingularPlural(
                "Singular", noun, Word(det, DET), ordinal, number
            )
    ...
    def noun_phrase_plural(self):
        ...
        if PRON_PER_PLURAL in self.current_token.type:
            ...
            if CLIT_Y in self.current_token.type:
                ...
                clit = None
            return NounPhraseSingularPlural(
                "Plural", Word(personal, PRON_PER_PLURAL), extra=clit
            )
            ...
            return NounPhraseSingularPlural(
                "Plural", noun, Word(pos, PRON_POS_PLURAL_NG)
            )
        else:
            ...
            return NounPhraseSingularPlural(
                "Plural", noun, Word(det, DET_PLURAL), ordinal, number
            )
    ...
    def noun_phrase_ang(self):
        ...
        number = (
            self.adj_num()
            if NUM in self.current_token.type or self.current_token.value == "ka"
            else None
        )
        if MGA in self.current_token.type:
            noun = self.noun_plural()
            return NounPhraseSingularPlural(
                ...
                ordinal,
                number,
                pos=Word(poss, PRON_POS_PLURAL_NG),
            )
        else:
            noun = self.noun_singular()
            return NounPhraseSingularPlural(
